...
public class ProductController {
	...
	@RequestMapping("/product/list-by-price1/{id}")
	public String listByPrice(Model model, @PathVariable("id") Integer id) {
		List<Product> list = pdao.findByPrice(id);
		model.addAttribute("list", list);
		return "product/list_special_full";
	}
	@RequestMapping("/product/list-by-price2/{id}")
	public String listByPrice1(Model model, @PathVariable("id") Integer id) {
		List<Product> list = pdao.findByPrice1(id);
		model.addAttribute("list", list);
		return "product/list_special_full";
	}
