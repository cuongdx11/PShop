...
public class AccountAdminController {
	...
	public String login(Model model) {
		Cookie ckid = cookie.read("adminuserid");
		Cookie ckpw = cookie.read("adminpass");
		if (ckid != null) {
	...
	public String login(Model model,
		...
		if (user == null) {
			...
			// ghi nho tk
			if (rm == true) {
				cookie.create("adminuserid", user.getId(), 30);
				cookie.create("adminpass", user.getPassword(), 30);
			} else {
				cookie.delete("adminuserid");
