	...
	<div class="panel-body">
		<form:form action="${base}/index" name="form" modelAttribute="entity">
			...
			<div>
				...
				<span class="btn btn-warning" style="padding:0px 10px 0px 10px"><form:radiobutton path="status" value="0" checked="checked" /> Chưa xử lý </span>
				<span class="btn btn-warning" style="padding:0px 10px 0px 10px"><form:radiobutton path="status" value="1"  /> Đang xử lý </span>
				...
				<span class="btn btn-danger" style="padding:0px 10px 0px 10px"><form:radiobutton path="status" value="4"  />  Đã hủy </span>
			</div>
			<br/>
			<div class="form-group">
				<label>Mô tả:</label>
