...
<nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="/admin/home/index"><img style="z-index: 0;margin-top: -10px;padding: 0px 0px 0px 20px" src="/static/images/pshoplogo.png" width="50%"/></a>
	</div>
	<!-- /.navbar-header -->
		...
		<li class="dropdown">
			...
			<c:choose>
				...
				<c:otherwise>
					<a class="dropdown-toggle" data-toggle="dropdown" href="#"> 
						<i class="fa fa-user fa-fw"></i>
						<i>Xin chào: ${sessionScope.adminuser.id}</i>					
					</a>
				</c:otherwise>	
			</c:choose>
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<c:choose>
					<c:when test="${empty sessionScope.adminuser }"> </c:when>
					<c:otherwise>
						<li>
				...
				<c:choose>
					...
					<c:otherwise>
						<li>
							<a href="/admin/voucher/index"><i class="fa fa-shopping-cart fa-fw"></i> Quản lý mã giảm giá</a>
						</li>
					</c:otherwise>
				</c:choose>
				<c:choose>
					...
					<c:otherwise>
						<li><a href="#"><i class="fa fa-dashboard fa-fw"></i> Quản lý thống kê<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a href="/admin/revenue/producttop">Mặt hàng bán chạy</a></li>
