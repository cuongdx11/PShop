			...
			<div class="row">
				...
				<div class="col-sm-7">
					<div class="san-pham-ct">
						...
						<p>
							Tình trạng: <span
								style="background-color: #99FF99; border-radius: 4px; padding: 3px; color: black; font-weight: bold;">${prod.quantity>0?'Còn hàng':'Hết hàng'}</span>
						</p>
					...
					<div class="sp-km">
						...
						<p>
							<img style="margin-top: -5px"
								src="/static/images/icon/icon_km.png" width="15px" height="15px">
							<span>Pin sạc dự phòng giảm 30% khi mua kèm</span>
						</p>
					</div>
				</div>
			</div>
	...
	<div class="col-sm-3">
		<div class="ct2">
			...
			<div class="sp-km">
				...
				<br>
				<h6>Dịch vụ khác</h6>
				<i><i class="fas fa-hammer ico"></i> &nbsp;Sửa chữa điện thoại
					giá rẻ</i><br> <i><i class="fas fa-laptop ico"></i> &nbsp;Thu
					cũ đổi mới </i><br> <i><i class="fas fa-satellite-dish ico"></i>
					&nbsp;Bảo hành tại nhà.</i>
			</div>
			<!-- /SHOP SIDEBAR -->
		</div>
