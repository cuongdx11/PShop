...
.thumbnail:hover {
	...
	<h3 class="title">
			...
			<b>Tìm kiếm được ${list5.size() } sản phẩm</b>
				...
				<div class="caption">
					...
					<p
						...
						<c:choose>
							<c:when test="${p.discount <= 0 }">
								<span
									style="text-align: left; font-weight: bold; color: #474c51"><f:formatNumber
						...
						<c:choose>
							<c:when test="${p.discount > 0 }">
								<span
									style="margin-left: 5px; font-weight: bold; color: #474c51">
